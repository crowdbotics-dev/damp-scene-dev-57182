"""
Django settings for damp_scene_dev_57182 project.
...
ROOT_URLCONF = 'damp_scene_dev_57182.urls'
...
WSGI_APPLICATION = 'damp_scene_dev_57182.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "damp_scene_dev_57182 API",
    "DESCRIPTION": "API documentation for damp_scene_dev_57182 App",
    "VERSION": "v1",
}
